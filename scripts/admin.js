...
show.innerText = JSON.stringify(api,null,4)
...
dataAPI = [
    {
    "stateName": "Rajastan",
    "titleImage": "https://www.indianholiday.com/images/new-home/2023/hawa-mahal-jaipur.jpg",
    ...
    "Visit Taj Mahal, Agra Fort, and Tomb of Itimad-Ud-Daulah",
    "Guided tour to Jaipur",
    ...
    "days": [
    "Arrival in Delhi",
    "Welcome to India! Upon arrival at IGI airport in Delhi, our tour representative will escort you to the pre-booked hotel. After completing check-in formalities, you can rest or walk around the neighboring streets to be familiar with Delhi's culture before sinking into your bed's coziness. Then, enjoy an overnight stay at the hotel in Delhi.",
    " Delhi Sightseeing",
    "Savor a hearty breakfast and proceed for a full-day city tour. Today, the Delhi sightseeing tour will cover Laxmi Narayan Temple, Parliament House, and Gandhi Memorial. After lunch, enjoy shopping at Connaught Place market. Next, make your way to India Gate, located at the heart of Delhi, and then drive off to Qutub Minar. Click the pictures here and leave for Humayun's Tomb, followed by Jama Masjid. End the tour with a Light and Sound Show at the Red Fort complex. Finally, return to your hotel for a comfortable overnight stay.",
    "Delhi - Agra",
    "After an early breakfast, you will leave Delhi to Agra by road (approx. 4 hours journey). On your arrival in Agra, check-in at your hotel. After some rest, enjoy a sightseeing tour of Agra covering Agra Fort, Tomb of Itimad-Ud-Daulah, and the Taj Mahal. Then, head back to your hotel for an overnight stay as the sun goes down.",
    "Agra - Jaipur",
    "On the 4th day of the Golden Triangle tour, post breakfast, check-out, and leave from Agra to Jaipur (approx. 5 hours journey). On the way, halt at Fatehpur Sikri, the abandoned Mughal town. The attractions you will cover here include Jama Masjid, Jodha Bai Palace, Birbal Bhawan, Panch Mahal, and Buland Darwaza. On reaching Jaipur, check-in at the hotel for a night stay.",
    "Jaipur Sightseeing",
    "After a fulfilling breakfast, proceed for the Jaipur city tour. First, admire the class of Rajput architecture and colorful Rajasthani culture. Then, enjoy an elephant ride to the Amber Fort. Next, visit Jaipur City Palace, renowned for its cultural value and architectural excellence. Opposite City Palace stands Jantar Mantar. Also known as the Royal Observatory, it houses a collection of astronomical instruments. Next, enjoy shopping at Bapu Bazar, Johari Bazaar, and Mirza Ismail Road. Post sightseeing, return to the hotel for a night's stay.",
    "Departure from Delhi",
    "This day marks the end of your 6 days on Golden Triangle Tour India. After a leisurely breakfast, begin the drive from Jaipur to Delhi. Upon arrival, you will be transferred to the airport to board a flight for a journey back home with pleasant memories."
    ],
    "id": 11
    },
    {
    ...
    "tripHighlights": [
    "Scenic drive to Shimla from Delhi.",
    "Trek to Jakhoo Temple.",
    "Enchanting snow-capped vistas at Scandal Point.",
    "A fantastic blend of neo-gothic architecture at Christ Church.",
    "Cultural and religious knowledge at Himachal State Museum."
    ],
    "days": [
    " Delhi: Arrival and Transfer to Shimla",
    "Shimla is the white winter queen of India, and your 2 nights/ 3 days trip will get started when you meet our representative-cum driver in Delhi. Our reprenseivate would be meeting you outside the airport or railway station. Post-meeting, you will be driven to Shimla from Delhi via road. The journey itself is a destination because the enchanting views outside your window will blow your mind. You can take halts for lunch on your way to Shimla from Delhi. Once you reach Shimla, get your check-in formalities completed. Take time to relax. In the evening, you can set your foot out for Mall Road hopping. Mall Road is a famous shopping place in Shimla to buy local souvenirs, and the place is dotted with several restaurants! Post-Mall Road fun, return to your hotel for scrumptious dinner, and then enjoy goodnight sleep. Note: Enrouting Shimla, lunch charges is additional. Also, Mall Road sightseeing is not included. Cover at your own pace. Distance from Delhi to Shimla: 350 kilometers (approx.) Travel Time: 8 hours (approx.)",
    "Shimla: Enjoy Sightseeing",
    "This day is the most important day of the Shimla tour from Delhi because you will be covering the major highlights of Shimla. So wake up early with a delicious morning meal and set your foot out for a local sightseeing tour on a guided excursion. Start with a trek to Jakhoo Hill, where the temple of Lord Hanuman is located with a 108 feet statue. A visit to this temple will leave you stunned as the temple is encircled with snow-capped peaks. Afterward, proceed for Christ Church - it is one of the oldest churches in North India, having a neo-gothic architecture design. Finally, watch the different collections of artifacts, handicrafts, paintings, and a lot more at the Himachal State Museum. This place is a blend of British architecture displaying the rich culture and heritage of Shimla. As the dusk approaches, go to Scandal Point to unlock the mesmerizing views of the valley encircling with snow-capped peaks. Of course, you will be in constant threat if you visit Scandal Point in the summers because it is the time when Shimla Summer Festival is held annually. End your 2nd day with fond moments. Then, get back to your hotel for a lip-smacking dinner. Doze off after a well-spent day!",
    "Delhi: Departure from Shimla",
    "Your holiday to Shimla from Delhi will end today. Relish mouthwatering breakfast and complete the check-out formalities. Then, you will be driven back to Delhi either at the airport or railway station in a comfortable and hygienic vehicle. Distance from Shimla to Delhi: 350 kilometers (approx.) Travel Time: 8 hours (approx.)"
    ],
    "id": 12
    },
    {
    ...
    "Thekkady - Kumarakom (122 km/ 3 hr 30 min -Approx.)",
    "Post breakfast on the 5th day; begin your road journey for Kumarakom. On the way, you are going to enjoy the picturesque locations. On arrival, check into a hotel alongside Vembanad Lake. Enjoy the natural beauty around. In the evening, venture out of your room and stroll around the lake or the nearby locations. If you want, you can also indulge in boat riding. After enjoying the day, you will return to your hotel to stay overnight.",
    " Kumarakom to Alleppey ( 33 km/1 hour- Approx.)",
    "Today after breakfast, you will be transported by road to Alleppey. Once you reach Alleppey, go on board a houseboat. Treat your eyes to the blissful nature around. During your journey on this luxury cruise, you will cruise along the calm nearby villages, paddy fields, etc. Observe the mesmerizing sunset too. Overnight stay on the houseboat.",
    "Alleppey - Cochin (54 km/ 1 hr- Approx.)",
    "In the morning, after having your breakfast, de-board the houseboat and hit the road to reach Cochin. Complete the check-in formalities once you arrive. In the first phase, you explored the monumental attractions of the city; the second phase is fixed for exploring the famous markets of Cochin (Kochi). After that, you can shop for some unique handicrafts and silk clothes. Finally, spend the evening at leisure. Overnight stay.",
    "Departure",
    "Today is the last day you will get an on-time transfer to the Cochin Airport or the Railway station for the journey to your onward destination. So take back some beautiful memories and leave behind your grievances to make a new beginning."
    ],
    "id": 13
    },
    {
    ...
    "tripHighlights": [
    "Enjoy a fun cable car and yak ride on the Gangtok tour.",
    "Excursion to Tsomgo Lake, Gurudongmar Lake, & Baba Temple.",
    "Visit Buddhist Lachung Monastery in Sikkim tour.",
    "Go for a sightseeing tour of Yumthang (Zero Point).",
    "Enjoy a lovely view of the Shingbha wildlife sanctuary, Chopta Valley, and Thangu."
    ],
    "days": [
    "Arrival NJP/Bagdogra Airport to Gangtok",
    "Your Gangtok tour starts today. Our representative will attend to you on arrival at New Jalpaiguri Railway Station (NJP) / Bagdogra Airport (IXB) / Tenzing Norgay Bus Stand (Junction). From here, IHPL will be assisting your transfer to Gangtok, nearly 135 kilometers which is a 4.5 to 5 hour drive.",
    "Excursion to Tsomgo Lake & Baba Mandir (Full Day)",
    "Start your morning with a delicious breakfast at the hotel. Next is the Tsomgo Lake and Baba Mandir excursion, nearly 40 kilometers.",
    "Drive to Lachen from Gangtok",
    "Start the next day with an early morning breakfast in the hotel. Then, the drive to Lachen awaits. The 135 kilometers journey makes a 5-6 hour drive. Stop at Chungthang (96 kilometers from Gangtok) for lunch. Post lunch, the drive continues to Lachen (35 kilometers from Chungthang).",
    " Excursion to Gurudongmar Lake and Drive to Lachung",
    "Start another day with an early morning breakfast in the hotel. Next is the visit to Gurudongmar Lake, which is 55 km from Lachen. The almost 4 hours drive takes you on an adventure. The views are exciting and as the day is starting, the first rays of sun color everything in its splendid light.",
    "Visit Yumthang Valley & Drive to Gangtok",
    "The next day starts with breakfast in the hotel. Next on the schedule is the drive towards Yumthang, situated at nearly 11,800 feet. The one-hour drive to beautiful Yumthang crosses through the famous hot spring known for its curative properties for skin diseases.",
    "Journey back home",
    ...
    "tripHighlights": [
    "A bike ride in Kullu Valley",
    "A challenging drive on Rohtang Pass",
    "A drive through Bara-Lacha La",
    "Challenging drives to Khardung La, Chang La Pass, and Tanglang-La Pass",
    "Visit Thiksey and Shey monasteries",
    "Leh sightseeing",
    "Visit Pangong Tso",
    "Camping in Sarchu and Pangong Tso"
    ],
    "days": [
    "Arrival in Manali (By bus)",
    "Your tour starts as you arrive in Manali by bus. Meet with our tour representative, who will assist you with a swift transfer to one of our listed hotels. Complete check-in formalities and unwind. Have lunch at the hotel (not mentioned in inclusions) and prepare for your much-awaited motorbike trip. Then, get your wheels rolling on the winding roads of Kullu Valley. The joy ride is coupled with the scenery of the mighty Himalayas on one side and untamed River Beas. But be watchful of the tricky roads.",
    "Manali - Jispa (92 km / 3 hours)",
    "Wake up early, savor breakfast, and checkout from the hotel. Get ready for an adventurous day as it will take you to the famed Rohtang Pass. Then, drive through Lahaul, the home to monasteries and monks.",
    "Jispa - Sarchu (78 km / 2.5 hours)",
    "Arise for a nutritious breakfast and checkout from the hotel. As you set on to discover Ladakh by bike tour, drive to Sarchu. You have to beat the first challenge of the route - Bara-Lacha La (4890 m). You will experience Acute Mountain Sickness (AMS) effects with the increasing altitude. But stay strong as you have to conquer more, especially at the Bara-Lacha La peak.",
    "Sarchu - Leh (259 km / 7-8 hours)",
    ...
    "Leh - Nubra (116 km / 4 hours)",
    "Post breakfast, checkout from the hotel. On this day of your Ladakh bike tour, you will be heading to Nubra Valley via Khardung La. Your next halt will be North Pullu. Relax and regain your strength here while munching on some snacks. And then, resume your journey. En route, seek blessings at Diskit Monastery. On arrival at Nubra Valley, check in to the camp. After some rest, enjoy riding a double-hump camel.",
    "Nubra - Pangong Lake (274 km / 8 hours)",
    "Wake up and have a filling breakfast. Then, checkout from the camps and ride to Pangong Lake via Shyok. This blue lake displays a striking contrast to the arid mountains around. En route, cross Chang La - one of the world's highest motorable roads. When you reach Pangong, check into the camp. Relax and soak in the lake's ethereal beauty.",
    "Pangong - Leh (229 km / 6 hours)",
    "Distance from Pangong to Leh: 216 km Travel Time: 13 hours (approx.) Kick start your day with a wholesome breakfast and checkout from the hotel. From today onwards, your journey back home commences. Ride to Leh. On arrival, check in to the camp and rest. Next, visit Shanti Stupa, a spectacular white structure. Then, go shopping to buy home souvenirs from Leh. Also, soak in the scenery of Indus Valley and the Zanskar Range.Once the day is over, return to the camp for dinner and sleep.",
    "Leh - Sarchu (259 km / 7-8 hours)",
    "Distance from Leh to Sarchu: 259 km Travel Time: 7 hours (approx.) Begin your day 8 of the bike tour in Ladakh with a hearty breakfast and checkout from the camps. Then, tread your wheels back to Sarchu while crossing Pang. Your arrival in Sarchu is marked by check-in to the hotel. The remaining day is at your leisure. Enjoy it just as you want. Later, have dinner and have a comfortable stay overnight at the hotel.",
    "Sarchu - Manali (210 km / 6 hours)",
    "After a healthy breakfast, checkout from the hotel. Drive to Manali. Reach Bara-Lacha La till noon followed by a smooth drive to Lahaul. Your drive proceeds to Rohtang Pass and you reach Manali at night. Check-in to the hotel, have dinner, and have a comforting sleep.",
    "Manali (Departure)",
    "Today, your Ladakh bike trip package ends. So, after breakfast, checkout from the hotel. Leave Manali with a heartful of memories, a camera loaded with pictures and videos, and an experience of a lifetime."
    ],
    "id": 17
    },
    {
    ...
    "days": [
    " Dwarka (Arrival)",
    "Upon arrival in Dwarka, check into the hotel and relax for some time. Later, you can visit the Nageshwar Jyotirlinga Temple and Gopi (believed to be the venue of Lord Krishna's playful dance with Gopis). Later take a ferry boat ride to the holy Island of Bet Dwarka.",
    " Dwarka - Porbander - Somnath",
    "In the morning, partake in the Aarti at Dwarakadhish Temple. Post breakfast, leave by road for Somnath. On the way, visit Porbandar, the birth place of Mahatma Gandhi. Upon arrival in Somnath, visit the Somnath Temple, where you can also attend the evening aarti or see the Sound and Light Show. Overnight stay and dinner at the Somnath.",
    ...
    "tripHighlights": [
    "Visit the North Goa beaches- Anjuna, Baga and Calangute.",
    "Visit the South Goa- Colva Beach.",
    "Visit the Old Goa churches such as Basilica of Bom Jesus and Chapel of St. Francis Xavier.",
    "Enjoy the party scene at Tito's Bar.",
    "Visit the famous Fort Aguada.",
    "Visit the local markets of Anjuna-traditional jewelry, handicrafts and souvenirs."
    ],
    "days": [
    "Goa",
    "Upon your arrival at the Goa airport/ railway station, your 3 days trip to Goa has started. Our tour representative assists you in smooth transfer to the hotel for a pre-booked stay. The first day of your Goa trip will acquaint you with the rich Portuguese culture and heritage of this tiny Indian state. There are several remnants in Old Goa in the form of century-old cathedrals such as Basilica of Bom Jesus and Chapel of St. Francis Xavier. Goa is also known for its massive forts which were built by Indian rulers and Portuguese colonies which settled in Goa in the 15th century. Besides, you can visit the famous 'Fort Aguada' whose major portions have been converted into a luxury hotel. Post sightseeing, return to the hotel for dinner and night stay.",
    "Goa",
    "The 2nd day of your 3 days tour to Goa is dedicated to the exploration of North Goa beaches. The charm of Goa beaches lies in its beautiful beaches lined on the seashore and attracts a huge crowd of Indian and international tourists. Some popular beaches that you can visit include Anjuna, Baga, and Calangute. These beaches will allow you to indulge in water sports such as Parasailing, scuba diving, and water skiing. Besides, you can visit the local markets at Anjuna where you can purchase traditional jewelry, handicrafts, and souvenirs. The 2nd day of your Goa Trip will make you experience the nightlife of Goa. Proceed towards the Tito's bar, one of the most happening party places in Goa to enjoy the vibrant nightlife. Besides, you can also visit the Ingo's Saturday Night Bazaar famous for shopping. Dinner and overnight stay in Goa.",
    "Goa",
    "On the 3rd day of your Goa Trip, you will head straight towards South Goa. Colva is a popular beach in South Goa. The beach is home to shacks, resort complexes, tourist cottages, discos, and eateries. Have some fun and laze around as the day will mark the end of your Goa 3 day trip plan. You will be assisted in smooth transfer to the Goa airport/railway station to board flight/train for onwards journey."
    ],
    "id": 19
    },
    {
    ...
    "tripHighlights": [
    "Bow down in worship of Lord Shiva at Sri Ramanathaswamy Temple",
    "Seek blessings at Meenakshi Amman Temple, Madurai",
    "Pay homage at Kanyakumari Temple, Kanyakumari",
    "Explore the Vivekananda Rock Memorial and Thiruvalluvar Statue"
    ],
    "days": [
    "Madurai",
    ...
    {
    "stateName": "Rajastan",
    "cardTitle": "Udaipur and Mount Abu Tour",
    "cardImage": "https://www.indianholiday.com/pictures/tourintro/blissful-rajasthan-tour-831.jpeg?360x242",
    "city": "Delhi – Agra – Fatehpur Sikri – Dhula Raoji – Jaipur – Delhi",
    "cost": "15500",
    "period": "5 N / 6 D",
    "cardbigImage": "https://www.indianholiday.com/pictures/tourthumb/golden-triangle-with-dunes-1133.jpeg",
    "overview": "Indian Holiday presents Golden Triangle with Dunes, which is one of the most sought-after tour packages. Get ready for the perfect introduction to Indian history and culture, coupled with exploring the ethereal desert dunes. The 6-day tour starts from Delhi, covering Delhi, Agra, Fatehpur Sikri, the dunes of Dhula Raoji, and Jaipur.\n\n",
    "tripHighlights": [
    "Guided trip to Delhi- India Gate, Laxmi Narayan Temple, Red Fort, Humayun’s Tomb and Qutub Minar etc.",
    "Guided tour Agra- Taj Mahal, Red Fort and other sights",
    "Excursion to the abandoned city of Fatehpur Sikri",
    "Camel ride in Sand dunes",
    "Elephant ride to Amer fort",
    "Guided to jaipur- City Palace & Jantar Mantar"
    ],
    "days": [
    " Arrival at the Delhi airport",
    "The Golden Triangle with Dunes tour starts with your arrival at the Delhi Airport. Meet the IHPL representative who will escorts you to the hotel. Check-in and relax. The day is at your leisure. Go sightseeing, shopping or have fun trying the nighttime activities.",
    "Delhi Sightseeing",
    "Start the day with a sumptuous breakfast in the hotel and get ready for exploring Delhi sightseeing tour. Stop for a visit to the impressive Laxmi Narayan Temple. Next, proceed to India Gate, the iconic cenotaph commemorating Indian martyrs. Explore Lutyen's Delhi making stop at the Parliament House, Rashtrapati Bhavan. Take a quick insight of Old Delhi at the Jama Masjid, India's largest mosque. The other sights from history preserving the rich heritage of unique architecture is the towering Qutab Minar, historic Purana Quila, Humayun's Tomb and Jantar Mantar observatory. The day also includes a visit to the Raj Ghat, Mahatma Gandhi's memorial to pay homage to the Father of the Nation.",
    "Delhi to Agra",
    "The charm of the Mughal city of Agra is the Taj Mahal. The white marble mausoleum is one of the wonders of the world. The Mughal Emperor Shah Jahan built the Taj as a token of love for his beloved wife Mumtaz Mahal. The icon of love is thronged by tourists from far and wide. Later, proceed for a visit of the marvelous Agra Fort. End the tour with a visit to Itmad-ud-Daula's Tomb whose design are truly exquisite! Later in the evening, go shopping for local treasures.",
    "Agra – Fatehpur Sikri – Dhula Raoji",
    "Early morning, check out of your hotel and proceed towards Agra to Dhula Raoji by road. En route, stop for a quick visit to the Fatehpur Sikri. The sandstone city of Emperor Akbar has been abandoned but its charm still remains the same. On your day tour cover the opulent Jama Masjid, the Buland Darwaza which is also the world's largest gateway, the historical Palace of Jodha Bai, Birbal Bhavan and Panch Mahal.",
    " Dhula Raoji – Jaipur",
    "Early in morning proceed for village safari and also trekking. Get back to your hotel and treat yourself to sumptuous breakfast. Check out of your hotel and proceed to Jaipur. On your arrival, check in at one of the listed hotels.",
    "Jaipur – Delhi",
    "It is the last day of your India tour Delhi, Agra & Jaipur. Early in morning visit Amer fort seated on Elephant back. If you are interested for shopping, visit the markets for some amazing bargains. Later, your journey will start from Jaipur to Delhi by road. On your arrival, head straight to the airport/railway station to board the onward flight/train."
    ]
    }
    ]